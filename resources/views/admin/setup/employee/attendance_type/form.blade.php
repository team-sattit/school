@php
$route = 'setup.employee.attendance_type.';
$lang = 'setup.employee.attendance_type.';
@endphp
@if(isset($model))
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    {{ Form::select('type', ['' => __($lang.'type.palceholder'), 'present' => __($lang.'type.present'), 'holiday' => __($lang.'type.holiday'), '' => __($lang.'type.absent'), '' => __($lang.'type.absent'), 'half_day' => __($lang.'type.half_day')], Null, ['class' => 'form-control select', 'data-placeholder' =>  __($lang.'form.type'), 'required' => '', 'data-parsley-errors-container' =>'#type-error']) }}
