@php
	...
	$js = ['setup/employee/attendance_type'];
@endphp
...
<div class="card">
	<div class="card-header header-elements-inline">
		...
		@can('create-employee_attendance_type')
