@php
	$route = 'setup.employee.employee_document_type.';
	$lang = 'setup.employee.employee_document_type.';
	$page = 'Religion';
	$js = ['setup/employee/employee_document_type'];
@endphp
...
<div class="card">
	<div class="card-header header-elements-inline">
		...
		@can('create-employee_document_type')
	...
	@can('view-employee_document_type')
	<div class="card-body">
