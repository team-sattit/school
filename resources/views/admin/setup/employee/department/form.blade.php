...
<fieldset class="mb-3">
    ...
    <div class="form-group row">
        {{ Form::label('code',  __($lang.'form.code_label'), ['class' => 'col-form-label col-lg-4 text-right required']) }}
        <div class="col-lg-6">
            {{ Form::text('code', Null, ['class' => 'form-control', 'placeholder' =>  __($lang.'form.code'), 'required' => '']) }}
        </div>
    </div>
    <div class="form-group row">
