...
namespace App\Http\Controllers\Admin\Setup\Misc;

use App\Http\Controllers\Controller;
use App\Http\Requests\Setup\Misc\NationalityRequest;
...
class NationalityController extends Controller {
	...
	public function __construct(
		...
		$this->model = $model;
		$this->repo = $repo;
		$this->view = 'admin.setup.misc.nationality.';
		$this->lang = 'setup.misc.nationality.';
	}
	/**
