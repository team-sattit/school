...
use App\Http\Requests\Setup\Employee\DesignationRequest;
...
class DesignationController extends Controller {
	...
	public function __construct(
		...
		$this->model = $model;
		$this->repo = $repo;
		$this->view = 'admin.setup.employee.designation.';
		$this->lang = 'setup.employee.designation.';
	}
	/**
	...
	public function create() {
		...
		if ($this->request->ajax()) {
			return view($this->view . 'form', $this->repo->getPreRequisite());
		} else {
			return abort(404);
		}
	...
	public function edit($id) {
		...
		if ($this->request->ajax()) {
			...
			return view($this->view . 'form', compact('model'), $this->repo->getPreRequisite());
		} else {
			return abort(404);
		}
	}
