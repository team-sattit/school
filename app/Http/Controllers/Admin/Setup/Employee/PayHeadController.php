...
use App\Http\Requests\Setup\Employee\PayHeadRequest;
use App\Model\Setup\Employee\PayHead;
use App\Repositories\Setup\Employee\PayHeadRepository;
...
class PayHeadController extends Controller {
	...
	public function __construct(
		...
		$this->model = $model;
		$this->repo = $repo;
		$this->view = 'admin.setup.employee.pay_head.';
		$this->lang = 'setup.employee.pay_head.';
	}
	/**
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function update(PayHeadRequest $request, $id) {
		$this->authorize('update', $this->repo->model());
		if ($this->request->ajax()) {
