...
use App\Http\Requests\Setup\Employee\AttendanceTypeRequest;
use App\Model\Setup\Employee\AttendanceType;
use App\Repositories\Setup\Employee\AttendanceTypeRepository;
...
class AttendanceTypeController extends Controller {
	...
	public function __construct(
		...
		$this->model = $model;
		$this->repo = $repo;
		$this->view = 'admin.setup.employee.attendance_type.';
		$this->lang = 'setup.employee.attendance_type.';
	}
	/**
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function update(AttendanceTypeRequest $request, $id) {
		$this->authorize('update', $this->repo->model());
		if ($this->request->ajax()) {
