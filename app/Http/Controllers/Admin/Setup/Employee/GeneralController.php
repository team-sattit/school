...
use App\Http\Requests\Setup\Employee\DepartmentRequest;
...
class GeneralController extends Controller {
	...
	public function __construct(
		...
		$this->repo = $repo;
		$this->view = 'admin.setup.employee.';
		$this->lang = 'setup.employee.general.';
	}
	/**
	...
	public function index() {
		...
		return view($this->view . 'index', compact('config'));
	}
