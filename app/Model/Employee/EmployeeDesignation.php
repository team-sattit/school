...
class EmployeeDesignation extends Model {
	...
	public function employeeTerm() {
		return $this->belongsTo('App\Model\Employee\EmployeeTerm');
	}

	public function designation() {
		return $this->belongsTo('App\Model\Setup\Employee\Designation');
	}

	public function department() {
		return $this->belongsTo('App\Model\Setup\Employee\Department');
	}
