...
class LeaveAllocation extends Model {
	...
	protected $fillable = ['employee_id', 'start_date', 'end_date', 'description', 'options',
	];
	...
	public function leaveAllocationDetails() {
		return $this->hasMany('App\Model\Employee\LeaveAllocationDetail', 'employee_leave_allocation_id');
	}
